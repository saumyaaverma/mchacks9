        ...
        if error != nil {
            ...
            Auth.auth().createUser(withEmail: email, password: password) { result, err in
                if err != nil {
                    ...
                    db.collection("users").addDocument(data: ["firstname" : firstName, "lastname" : lastName, "uid": result!.user.uid, "country": country,"city": city,"address": address,"postalCode":postalCode,"isAvailable": isAvailable, "cost": cost, "email":email]) { (error) in
                        if error != nil{
                            //show error message
